...
third_dict.update({key: [first_dict[key], second_dict[key]] for key in com_keys}) #Знайшов рішення з таким циклом в гуглі, але хотілось би розібрати на уроці його, бо не до кінця зрозумів
